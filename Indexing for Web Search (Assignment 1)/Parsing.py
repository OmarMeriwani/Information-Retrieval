...
relations = pd.DataFrame(columns=['Page','Location','Word','Vector_representation','Relative_Position','IsNER','InLink','Relations','RelatedWords','General_Rank','Relative_Rank'])
...
senteces = nltk.tokenize.api.TokenizerI(Page1Text)
print (senteces)
'''===================
Words tokenization
===================='''
